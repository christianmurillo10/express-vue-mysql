...
MySQL - 5.5.5-10.1.36-MariaDB : Database - express_vue_mysql_live
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`express_vue_mysql_live` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `express_vue_mysql_live`;
